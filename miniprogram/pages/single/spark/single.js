...
Page({
  data: {
    ...
    ratio: 0,
    chapters: [
      { chapter: 'serial', chapterId: 1, checked: 0 },
      { chapter: 'Digital IO', chapterId: 2, checked: 0 },
      { chapter: 'Analog IO', chapterId: 3, checked: 0 },
      { chapter: 'Advanced IO', chapterId: 4, checked: 0 },
      { chapter: 'Times', chapterId: 5, checked: 0 }
    ],
    chapters_chosen: false,
    recommendationDone: false,
    chooseQuestionMarket: 0,
    questionMarket: [
      { title: '最新题库', market: 'latestMarket' },
      { title: '专属题库', market: 'market' }
    ]
  },
  ...
  connect () {
    ...
    var tunnel = that.tunnel = new qcloud.Tunnel(config.service.tunnelSpark)
